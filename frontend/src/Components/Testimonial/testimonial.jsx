...
export default function Testimonial() {
	return (
		<section className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-21 lg:px-8">
			<div className="mx-auto max-w-2xl lg:max-w-4xl">
				<h1 className="text-4xl text-center">Musia</h1>
				<figure className="mt-10">
					...
					<figcaption className="mt-10">
						...
						<div className="mt-4 flex items-center justify-center space-x-3 text-base">
							...
							<div className="text-gray-600">CEO of Musia</div>
						</div>
					</figcaption>
				</figure>
			</div>
